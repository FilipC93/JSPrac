function convertToRoman(num) {
    var arabicToRoman = {
        ...
        500: "D", 600: "DC", 700: "DCC", 800: "DCCC", 900: "CM", 1000: "M", 2000: "MM",
        3000: "MMM"
    };
    var digits = String(+num).split(""); //array with digits
    var result = ''; //empty result initialized
    for (var i = 0; i < digits.length; i++) {
        var lookUpKey = digits[i] * Math.pow(10, digits.length - i - 1); //find the key of the current index value multiplied by the power of 10^i
